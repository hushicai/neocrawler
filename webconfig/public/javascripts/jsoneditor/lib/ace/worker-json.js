'no use strict'; function initBaseUrls (e) { require.tlns = e; } function initSender () {
  var e = require(null, 'ace/lib/event_emitter').EventEmitter, t = require(null, 'ace/lib/oop'), n = function () {};

  return (function () { t.implement(this, e), this.callback = function (e, t) { postMessage({type: 'call', id: t, data: e}); }, this.emit = function (e, t) { postMessage({type: 'event', name: e, data: t}); }; }.call(n.prototype)), new n();
} if (typeof window != 'undefined' && window.document) throw 'atempt to load ace worker into main window instead of webWorker'; var console = {log: function () {
    ...
    if (!t.charAt) throw new Error('worker.js require() accepts only (parentId, id) as arguments'); t = normalizeModule(e, t); var n = require.modules[t];

    if (n) return n.initialized || (n.initialized = !0, n.exports = n.factory().exports), n.exports; var r = t.split('/');

    r[0] = require.tlns[r[0]] || r[0]; var i = r.join('/') + '.js';

    return require.id = t, importScripts(i), require(e, t);
  };

require.modules = {}, require.tlns = {}; var define = function (e, t, n) {
    arguments.length == 2 ? (n = t, typeof e != 'string' && (t = e, e = require.id)) : arguments.length == 1 && (n = e, e = require.id); if (e.indexOf('text!') === 0) return; var r = function (t, n) { return require(e, t, n); };
...
onmessage = function (e) {
  ...
  if (t.command) { if (!main[t.command]) throw new Error('Unknown command:' + t.command); main[t.command].apply(main, t.args); } else if (t.init) {
    initBaseUrls(t.tlns), require(null, 'ace/lib/fixoldbrowsers'), sender = initSender(); var n = require(null, t.module)[t.classname];
  ...
  r.inherits(o, i), (function () {
    this.onUpdate = function () {
      ...
      try { var t = s(e); } catch (n) {
        var r = this.doc.indexToPosition(n.at - 1);

        this.sender.emit('error', {row: r.row, column: r.column, text: n.message, type: 'error'}); return;
      } this.sender.emit('ok');
    };
  }.call(o.prototype));
  ...
  var r = e('../document').Document, i = e('../lib/lang'), s = t.Mirror = function (e) {
      this.sender = e; var t = this.doc = new r(''), n = this.deferredUpdate = i.deferredCall(this.onUpdate.bind(this)), s = this;

      e.on('change', function (e) { t.applyDeltas([e.data]), n.schedule(s.$timeout); });
    };

  (function () { this.$timeout = 500, this.setTimeout = function (e) { this.$timeout = e; }, this.setValue = function (e) { this.doc.setValue(e), this.deferredUpdate.schedule(this.$timeout); }, this.getValue = function (e) { this.sender.callback(this.doc.getValue(), e); }, this.onUpdate = function () {}; }).call(s.prototype);
  ...
  var r, i, s = {'"': '"', '\\': '\\', '/': '/', b: '\b', f: '\f', n: '\n', r: '\r', t: '	'}, o, u = function (e) { throw {name: 'SyntaxError', message: e, at: r, text: o}; }, a = function (e) { return e && e !== i && u("Expected '" + e + "' instead of '" + i + "'"), i = o.charAt(r), r += 1, i; }, f = function () {
      ...
      i === '-' && (t = '-', a('-')); while (i >= '0' && i <= '9')t += i, a(); if (i === '.') { t += '.'; while (a() && i >= '0' && i <= '9')t += i; } if (i === 'e' || i === 'E') { t += i, a(); if (i === '-' || i === '+')t += i, a(); while (i >= '0' && i <= '9')t += i, a(); }e = +t; if (!isNaN(e)) return e; u('Bad number');
    }, l = function () {
      var e, t, n = '', r;

      if (i === '"') while (a()) { if (i === '"') return a(), n; if (i === '\\') { a(); if (i === 'u') { r = 0; for (t = 0; t < 4; t += 1) { e = parseInt(a(), 16); if (!isFinite(e)) break; r = r * 16 + e; }n += String.fromCharCode(r); } else { if (typeof s[i] != 'string') break; n += s[i]; } } else n += i; }u('Bad string');
    }, c = function () { while (i && i <= ' ')a(); }, h = function () { switch (i) { case 't':return a('t'), a('r'), a('u'), a('e'), !0; case 'f':return a('f'), a('a'), a('l'), a('s'), a('e'), !1; case 'n':return a('n'), a('u'), a('l'), a('l'), null; }u("Unexpected '" + i + "'"); }, p, d = function () {
      var e = [];

      if (i === '[') { a('['), c(); if (i === ']') return a(']'), e; while (i) { e.push(p()), c(); if (i === ']') return a(']'), e; a(','), c(); } }u('Bad array');
    }, v = function () {
      var e, t = {};

      if (i === '{') { a('{'), c(); if (i === '}') return a('}'), t; while (i) { e = l(), c(), a(':'), Object.hasOwnProperty.call(t, e) && u('Duplicate key "' + e + '"'), t[e] = p(), c(); if (i === '}') return a('}'), t; a(','), c(); } }u('Bad object');
    };

  return p = function () { c(); switch (i) { case '{':return v(); case '[':return d(); case '"':return l(); case '-':return f(); default:return i >= '0' && i <= '9' ? f() : h(); } }, function (e, t) {
    var n;

    return o = e, r = 0, i = ' ', n = p(), c(), i && u('Syntax error'), typeof t == 'function' ? (function s (e, n) {
      var r, i, o = e[n];

      if (o && typeof o == 'object') for (r in o)Object.hasOwnProperty.call(o, r) && (i = s(o, r), i !== undefined ? o[r] = i : delete o[r]); return t.call(e, n, o);
    }({'': n}, '')) : n;
  };
});
